  ...
  const handleAnalyze = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.message && err.message.includes("Requested entity was not found")) {
        setError("API key error: The selected API key might be invalid or require a paid Google Cloud project. Please ensure your environment is correctly configured.");
      } else {
